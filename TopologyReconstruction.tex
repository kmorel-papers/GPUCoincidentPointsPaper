...
\fix{TODO: Discuss actual algorithms using this technique.  The following
  section should describe algorithms that output their cells on the
  reduce.}
...
\fix{I am conflicted about the position of this section.  Part of me wants
  to put it in or next to the Marching Cubes subsection.  Part of me wants
  it here after ther vertex welding while it is still fresh.  Part of me
  wants it after the grouping cell connections so that the funny welding
  can be introduced after the standard, exact welding is completed.}
