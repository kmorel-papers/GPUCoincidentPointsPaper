...
\begin{figure}[htb]
\centering
  \includegraphics[width=0.85\linewidth]{MapPartitionReduce.pdf}
...
\ref{table:SubdivisionOpenMP}. Figure~\ref{fig:subdivision} shows an example
of cell subdivision on a surface.
