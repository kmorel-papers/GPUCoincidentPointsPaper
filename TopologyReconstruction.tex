...
\quad
\subfloat[Face-Centered Tetrahedralization\label{fig:teaser:tetrahedral} \fix{Replace adjacent small dots with larger dots covering nearby vertices.  It would make the dots easier to see and would be more consistent with other figures}]{\includegraphics[height=0.32\columnwidth]{TetrahedralExample.pdf}}
\quad
